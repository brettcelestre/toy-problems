...
[
  ...
  // './algorithms/tests/tripletSum.test.js',
  // './algorithms/tests/counter.test.js',
  ...
  // './arrays/tests/plus_minus.test.js',

  // './async/tests/asyncMap.test.js',

  // './binarySearchTree/tests/binary_search_tree.tests.js',

  // './DOM/tests/clock/clock.test.js'
  ...
  // './math/tests/fibonacci.test.js',

  // './matrix/tests/rotate.test.js',

  // './promises/tests/promise_getToSix.test.js',
  ...
  // './strings/tests/longestRun.test.js',
  // './strings/tests/snake_case_converter.test.js',
  // './strings/tests/string_generator.test.js',
  // './strings/tests/reverseString.test.js',
